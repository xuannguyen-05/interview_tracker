...
router.post("/", upload.single("resume"), validate(createApplicationSchema), createApplication)
router.get("/", validate(filterApplicationSchema, 'query'), getApplications)
router.get("/:id", getApplicationById)
router.patch("/:id", upload.single("resume"), validate(updateApplicationSchema), updateApplication)
